...
/// operations related to chat entities.
/// </summary>
public interface IChatRepository : IBaseRepository<Chat>
{
    ...
    /// </param>
    /// <returns>
    /// A collection of chats the user is a member of.
    /// </returns>
    ...
    /// <summary>
    /// Retrieves a personal (1-on-1) chat between 
    /// two specific users, if it exists.
    /// Specifically filters for chats where IsGroup is false.
    /// </summary>
    /// <param name="user1Id">
    /// The unique identifier of the first user.
    /// </param>
    /// <param name="user2Id">
    /// The unique identifier of the second user.
    /// </param>
    /// <param name="cancellationToken">
    /// A token to monitor for cancellation requests.
    /// </param>
    /// <returns>
    /// The personal chat entity if found; otherwise, null.
    /// </returns>
    ...
    /// including all its details (members and messages).
    /// </summary>
    /// <param name="chatId">
    ...
    /// </param>
    /// <returns>
    /// The chat entity if found; otherwise, null.
    /// </returns>
